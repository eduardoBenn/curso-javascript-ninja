(function () {
    ...
    */
    console.log('\nJust Numbers:');
    var justNumbers = numberObjects.map(function (numbers) {
    ...
    no console.
    */
    var justMod2Or3 = justNumbers.filter(function (numbers) {
    ...
    */
    ...
    var brincadeira = name.reduce(function (acumulado, atual) {
    ...
    */
    ...
    console.log((numberObjects.indexOf({ number: 2 }) > -1)
        ? "Existe um objeto { number: 2 } em numberObjects!"
        : "Não existe um objeto { number: 2 } em numberObjects :(");
    /*
    ...
    */
    ...
    console.log((numberObjects.lastIndexOf({ number: 2 }) > -1)
        ? "Existe um objeto { number: 2 } em numberObjects!"
        : "Não existe um objeto { number: 2 } em numberObjects :(");
    /*
