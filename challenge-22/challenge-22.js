(function (win, doc) {
  ...
  */
  function sum() {
    ...
    return Array.prototype.reduce
      .call(arguments, function (accumulated, actual) {
  ...
  */
  ...
  function justNumbers(stringEntry) {
    return stringEntry.replace(/\D+/g, ',').split(',');
  }

  console.log(justNumbers('232eduardo0e2o0e'));
  /*
