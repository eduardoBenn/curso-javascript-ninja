(function () {
    ...
    */
    ...
    var names = ['eduardo', 'joão', 'pedro', 'maria', 'jose'];
    ...
    */
    ...
    var roberto = 'Roberto';
    // console.log(roberto.slice(0, roberto.length - 1) + 'a');
    ...
    */
    ...
    var myName = 'Eduardo';
    var newMyname = myName.split('').map(function (letter, index) {
        return (index % 2 === 0)
