...
(function () {
    ...
    */
    ...
    console.log(sum(function (num, num2) {
        return num + num2;
    }));
    /*
    ...
    */
    var subtraction = calculator(4, 3);
    var multiplication = calculator(5, 6);
    ...
    */
    ...
    console.log(subtraction(function (num, num2) {
        return num - num2;
    }));

    console.log('O resultado da multiplicação é:');
    console.log(multiplication(function (num, num2) {
        return num * num2;
    }));

    console.log('O resultado da divisão é:');
    console.log(division(function (num, num2) {
        return num / num2;
    }));

    console.log('O resto da divisão é:');
    console.log(mod(function (num, num2) {
        return num % num2;
    }));
