(function () {
    ...
    function calculator(operator) {
        if (isOperatorValid(operator)) {
            return function (param, param2) {
                if (!Number(param) || !Number(param2)) {
                    return false;
                }
                return operation[operator](param, param2);
            }
        }
    ...
    */
    function showOperationMessage(operator, num, num2) {
        return 'A operação ' + num + ' ' + operator + ' ' + num2 + ' = ';
    }
    /*
    ...
    */
    ...
    console.log((!!subtraction)
        ? showOperationMessage(operationSignal, number1, number2) + ' ' + subtraction(number1, number2)
        : showErrorMessage(operationSignal));
    ...
    console.log((!!multiplication)
        ? showOperationMessage(operationSignal, number1, number2) + ' ' + multiplication(number1, number2)
        : showErrorMessage(operationSignal));
    ...
    console.log((!!division)
        ? showOperationMessage(operationSignal, number1, number2) + ' ' + division(number1, number2)
        : showErrorMessage(operationSignal));
    ...
    console.log((!!mod)
        ? showOperationMessage(operationSignal, number1, number2) + ' ' + mod(number1, number2)
        : showErrorMessage(operationSignal));
