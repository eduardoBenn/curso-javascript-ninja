(function () {
    ...
    */
    var text = 'Manuel Marques de Sousa, Conde de Porto Alegre' +
        ...
        'apelidado de "O Centauro de Luvas", foi um militar, político, ' +
        'abolicionista e monarquista brasileiro.';
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Eduardo Bennertz'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'catarinense'));
    ...
    */
    ...
    function getMonthNumber(mounthName) {
        var mounths = {
            'janeiro': '01',
            'fevereiro': '02',
            'março': '03',
