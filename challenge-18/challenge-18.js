(function () {
  ...
  */
  ...
  var tagPhrase = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
  console.log(tagPhrase.match(/<\w+>/g));
  ...
  */
  ...
  var tagPhrase2 = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
  console.log(tagPhrase2.match(/<\w+><\/\w+>/g));
  ...
  */
  ...
  var tagPhrase3 = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';
  
  console.log(tagPhrase3.replace(
    /<(\w+)>([^<]+)<\/\w+>/g, 
